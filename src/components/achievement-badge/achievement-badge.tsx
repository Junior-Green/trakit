...
import {AngelWingsIcon, AssistIcon, BasketballBlockIcon, BasketballDunkIcon, BrickWallIcon, BugIcon, ClockIcon, CoinsIcon, EyeIcon, FootballCatchIcon, FootballPickupIcon, MeasuringTapeIcon, NinjaIcon, PassIcon, PenguinIcon, PinIcon, RescueIcon, SaveGoalIcon, SlimeIcon, StarIcon, StealIcon, SwordsIcon, TargetIcon, TurnoverIcon, WarningCardIcon} from "../svgs";

const badgeIconsList = ['assist', 'block', 'brick-wall', 'bug', 'clock', 'catch-football', 'pickup-football', 'measuring-tape', 'pass-ball', 'pin', 'rescue', 'save-goal', 'star', 'steal', 'reverse-arrows', 'swords', 'target', 'warning-card', 'eye', 'dunk-ball', 'slime', 'coins', 'penguin', 'angel-wings','ninja'] as const;
...
export const AchievementBadge = ({badgeIcon, tier}: AchievementBadgeProps) => {
    ...
    let tierClassName = styles.bronze;
    if (tier === 'silver') {
